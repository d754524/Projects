...
public final class UserInterface implements ActionListener {
	 ...
	 */
	private static final String HEADER = "<html><br /><center>Symbol Table</center><br /><----------------------------------------------------------------------------------><table border=\"0\"><tr><td width=\"75px\">Name</td><td width=\"75px\">Address</td><td width=\"75px\">Bytes (8 bits)</td></tr>";
