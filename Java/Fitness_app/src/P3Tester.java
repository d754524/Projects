...
public class P3Tester {
 ...
 //****************As per your petition, here you are: "Atharv Bogra and  Bob Ross************************   
           private final double ERR = 0.0001;
    @Test public void swimming_construct_def_01() { 
      ...
      @Test public void swimming_construct_def_02() { 
     ...
     void swimming_calorieLoss(int a)
      ...
      @Test public void swimming_calorieLoss_00() { swimming_calorieLoss(0); }
      @Test public void swimming_calorieLoss_01() { swimming_calorieLoss(1); }
      @Test public void swimming_calorieLoss_02() { swimming_calorieLoss(2); }
      ...
      @Test public void swimming_muscleTargeted_00() { swimming_muscleTargeted(0); }
      @Test public void swimming_muscleTargeted_01() { swimming_muscleTargeted(1); }
      @Test public void swimming_muscleTargeted_02() { swimming_muscleTargeted(2); }
   
      @Test public void swimming_description()
      {
      ...
      @Test public void cycling_inheritance() {
      ...
      @Test public void cycling_calorieLoss_00() { cycling_calorieLoss(0); }
      @Test public void cycling_calorieLoss_01() { cycling_calorieLoss(1); }
      @Test public void cycling_calorieLoss_02() { cycling_calorieLoss(2); }
      ...
      @Test public void cycling_muscleTargeted_00() { cycling_muscleTargeted(0); }
      
   
      @Test public void cycling_description()
      {
      ...
      @Test public void plyometrics_inheritance() {
      ...
      @Test public void plyometrics_calorieLoss_00() { plyometrics_calorieLoss(0); }
      @Test public void plyometrics_calorieLoss_01() { plyometrics_calorieLoss(1); }
      @Test public void plyometrics_calorieLoss_02() { plyometrics_calorieLoss(2); }
      ...
      @Test public void plyometrics_muscleTargeted_00() { plyometrics_muscleTargeted(0); }
      
   
     @Test public void plyometrics_description()
      {
      ...
      @Test public void weightlifting_inheritance() {
      ...
      @Test public void weightLifting_calorieLoss_00() { weightLifting_calorieLoss(0); }
      @Test public void weightLifting_calorieLoss_01() { weightLifting_calorieLoss(1); }
      @Test public void weightLifting_calorieLoss_02() { weightLifting_calorieLoss(2); }
      ...
      @Test public void weightLifting_muscleTargeted_00() { weightLifting_muscleTargeted(0); }
      
   
      @Test public void  weightLifting_description()
      {
      ...
      @Test public void pullup_inheritance() {
         Object o = new PullUp();
      ...
      @Test public void pullUp_calorieLoss_00() {pullUp_calorieLoss(0); }
      @Test public void pullUp_calorieLoss_01() { pullUp_calorieLoss(1); }
      @Test public void pullUp_calorieLoss_02() { pullUp_calorieLoss(2); }
      ...
      @Test public void pullUp_muscleTargeted_00() { pullUp_muscleTargeted(0); }
      
   
      @Test public void pullUp_description()
      {
      ...
      @Test public void squat_inheritance() {
         Object o = new Squat();
      ...
      @Test public void squat_calorieLoss_00() {squat_calorieLoss(0); }
      @Test public void squat_calorieLoss_01() { squat_calorieLoss(1); }
      @Test public void squat_calorieLoss_02() { squat_calorieLoss(2); }
      ...
      @Test public void squat_muscleTargeted_00() { squat_muscleTargeted(0); }
      
   
      @Test public void squat_description()
      {
      ...
      @Test public void taichi_inheritance() {
         Object o = new TaiChi();
      ...
      @Test public void taiChi_calorieLoss_00() {taiChi_calorieLoss(0); }
      @Test public void taiChi_calorieLoss_01() { taiChi_calorieLoss(1); }
      @Test public void taiChi_calorieLoss_02() { taiChi_calorieLoss(2); }
      ...
      @Test public void taiChi_muscleTargeted_00() { taiChi_muscleTargeted(0); }
      
   
      @Test public void taiChi_description()
      {
      ...
      @Test public void yoga_inheritance() {
         Object o = new Yoga();
      ...
      @Test public void yoga_calorieLoss_00() {yoga_calorieLoss(0); }
      @Test public void yoga_calorieLoss_01() { yoga_calorieLoss(1); }
      @Test public void yoga_calorieLoss_02() { yoga_calorieLoss(2); }
      ...
      @Test public void yoga_muscleTargeted_00() { yoga_muscleTargeted(0); }
      
   
      @Test public void yoga_description()
      {
  ...
  //***************Profile class Tests ********************************* 
      ...
      @Test public void profile_construct_def_02() { 
    ...
    @Test public void checkSetAge_00() { checkSetAge(0); }
    @Test public void checkSetAge_01() { checkSetAge(1); }
    @Test public void checkSetAge_02() { checkSetAge(2); }
    @Test public void checkSetAge_03() { checkSetAge(3); }
    ...
    void checkSetHeight(int a) {
      ...
      @Test public void checkSetHeight_00() { checkSetHeight(0); }
      @Test public void checkSetHeight_01() { checkSetHeight(1); }
      @Test public void checkSetHeight_02() { checkSetHeight(2); }
      @Test public void checkSetHeight_03() { checkSetHeight(3); }
      ...
      void checkSetWeight(int a) {
        ...
        @Test public void checkSetWeight_00() { checkSetWeight(0); }
        @Test public void checkSetWeight_01() { checkSetWeight(1); }
        @Test public void checkSetWeight_02() { checkSetWeight(2); }
        @Test public void checkSetWeight_03() { checkSetWeight(3); }
        ...
        void checkSetGender(int a) {
          ...
          @Test public void checkSetGender_00() { checkSetGender(0); }
          @Test public void checkSetGender_01() { checkSetGender(1); }
          @Test public void checkSetGender_02() { checkSetGender(2); }
          @Test public void checkSetGender_03() { checkSetGender(3); }
          ...
          void checkDailyCalorieIntake(int a) {
           ...
           @Test public void checkDailyCalorieIntake_00() { checkDailyCalorieIntake(0); }
           @Test public void checkDailyCalorieIntake_01() { checkDailyCalorieIntake(1); }
           @Test public void checkDailyCalorieIntake_02() { checkDailyCalorieIntake(2); }
           @Test public void checkDailyCalorieIntake_03() { checkDailyCalorieIntake(3); }
           ...
           void checkCalcBMI(int a) {
            ...
            @Test public void checkCalcBMI_00() { checkCalcBMI(0); }
            @Test public void checkCalcBMI_01() { checkCalcBMI(1); }
            @Test public void checkCalcBMI_02() { checkCalcBMI(2); }
            @Test public void checkCalcBMI_03() { checkCalcBMI(3); }            
         ...
         String result  =String.format("Age %d, Weight %.1fkg, Height %.1fm, Gender %s",xPValues[a],zPValues[a],yPValues[a],gP[a]);
            ...
            @Test public void checkProfile_toString_00() { checkProfile_toString(0); }
            @Test public void checkProfile_toString_01() { checkProfile_toString(1); }
            @Test public void checkProfile_toString_02() { checkProfile_toString(2); }
            @Test public void checkProfile_toString_03() { checkProfile_toString(3); }
  ...
  //****************DailyExercise class Tests *********************************   
      ...
      ArrayList<Fitness> exercise =new ArrayList<Fitness>(Arrays.asList(fit));//new ArrayList<Fitness>();
            
      @Test public void dailyExercise_construct_def_01() { 
         
      DailyExercise d = new DailyExercise(exercise,45,450,pro2);
            assertEquals("constructor DailyExercise() is incorrect", exercise, d.getExerciseList());
      ...
      @Test public void dailyExercise_construct_def_02() { 
             
          DailyExercise d = new DailyExercise(exercise,pro2);
                assertEquals("constructor DailyExercise() is incorrect", exercise, d.getExerciseList());
      ...
      int [] xDuration = {20,70,65,25};
        ...
        // Gender [] g = {Gender.MALE,Gender.FEMALE,Gender.MALE,Gender.FEMALE};
         ...
         Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
         DailyExercise d = new DailyExercise(exercise,xDuration[a],yCalorie[a],p);
            String errMsg1 = String.format("DailyExercise get/setProfile() incorrect");
              assertEquals(errMsg1, p, d.getProfile());
          
         }
          
         @Test public void checkDailyExerciseSet_GetProfile_00() { checkDailyExerciseSet_GetProfile(0); }
         @Test public void checkDailyExerciseSet_GetProfile_01() { checkDailyExerciseSet_GetProfile(1); }
         @Test public void checkDailyExerciseSet_GetProfile_02() { checkDailyExerciseSet_GetProfile(2); }
         @Test public void checkDailyExerciseSet_GetProfile_03() { checkDailyExerciseSet_GetProfile(3); }
         ...
         void checkDailyExerciseSet_GetDuration(int a) {
            ...
            @Test public void checkDailyExerciseSet_GetDuration_00() { checkDailyExerciseSet_GetDuration(0); }
            @Test public void checkDailyExerciseSet_GetDuration_01() { checkDailyExerciseSet_GetDuration(1); }
            @Test public void checkDailyExerciseSet_GetDuration_02() { checkDailyExerciseSet_GetDuration(2); }
            @Test public void checkDailyExerciseSet_GetDuration_03() { checkDailyExerciseSet_GetDuration(3); }
         ...
         void checkDailyExerciseSet_GetCalorieTarget(int a) {
            ...
            @Test public void checkDailyExerciseSet_GetCalorieTarget_00() { checkDailyExerciseSet_GetCalorieTarget(0); }
            @Test public void checkDailyExerciseSet_GetCalorieTarget_01() { checkDailyExerciseSet_GetCalorieTarget(1); }
            @Test public void checkDailyExerciseSet_GetCalorieTarget_02() { checkDailyExerciseSet_GetCalorieTarget(2); }
            @Test public void checkDailyExerciseSet_GetCalorieTarget_03() { checkDailyExerciseSet_GetCalorieTarget(3); }
        ...
        void checkDailyExerciseSet_GetExerciseList(int a) {
           Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
          ArrayList<Fitness> exercise2 =new ArrayList<Fitness>(Arrays.asList(fitData[a]));
           DailyExercise d = new DailyExercise(exercise2,xDuration[a],yCalorie[a],p);
              String errMsg1 = String.format("DailyExercise get/setExerciseList() incorrect");
                assertEquals(errMsg1, exercise2, d.getExerciseList());
            
           }
        
            
           @Test public void checkDailyExerciseSet_GetExerciseList_00() { checkDailyExerciseSet_GetExerciseList(0); }
           @Test public void checkDailyExerciseSet_GetExerciseList_01() { checkDailyExerciseSet_GetExerciseList(1); }
           @Test public void checkDailyExerciseSet_GetExerciseList_02() { checkDailyExerciseSet_GetExerciseList(2); }
           @Test public void checkDailyExerciseSet_GetExerciseList_03() { checkDailyExerciseSet_GetExerciseList(3); }
            
           
         void checkDailyExerciseAddExercise(int a) {
            Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
               ArrayList<Fitness> exercise3 =new ArrayList<Fitness>(Arrays.asList(fit));
               DailyExercise d = new DailyExercise(exercise3,xDuration[a],yCalorie[a],p);
               d.addExercise(newFit[a]);
               String errMsg1 = String.format("DailyExercise AddExercise() incorrect");
                 assertEquals(errMsg1, sizeAdd[a], d.getExerciseList().size());
             
            }
         
             
            @Test public void checkDailyExerciseAddExercise_00() { checkDailyExerciseAddExercise(0); }
            @Test public void checkDailyExerciseAddExercise_01() { checkDailyExerciseAddExercise(1); }
            @Test public void checkDailyExerciseAddExercise_02() { checkDailyExerciseAddExercise(2); }
            @Test public void checkDailyExerciseAddExercise_03() { checkDailyExerciseAddExercise(3); }
         ...
         void checkDailyExerciseRemoveExercise(int a) {
            Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
               ...
               String errMsg1 = String.format("DailyExercise removeExercise() incorrect");
                 assertEquals(errMsg1, false, d.getExerciseList().contains(newFit[a]));
             
            }
         
             
            @Test public void checkDailyExerciseRemoveExercise_00() { checkDailyExerciseRemoveExercise(0); }
            @Test public void checkDailyExerciseRemoveExercise_01() { checkDailyExerciseRemoveExercise(1); }
            @Test public void checkDailyExerciseRemoveExercise_02() { checkDailyExerciseRemoveExercise(2); }
            @Test public void checkDailyExerciseRemoveExercise_03() { checkDailyExerciseRemoveExercise(3); }
      ...
      return result;  
        ...
        void checkDailyExerciseGetExercises(int a) {
            ...
            @Test public void checkDailyExerciseGetExercises_00() { checkDailyExerciseGetExercises(0); }
            @Test public void checkDailyExerciseGetExercises_01() { checkDailyExerciseGetExercises(1); }
            @Test public void checkDailyExerciseGetExercises_02() { checkDailyExerciseGetExercises(2); }
            @Test public void checkDailyExerciseGetExercises_03() { checkDailyExerciseGetExercises(3); }
            
   //****************WeeklyExercise class Tests *********************************
         @Test public void weeklyExercise_construct_def_01() { 
          
         WeeklyExercise d = new WeeklyExercise(exercise,45,450,pro2);
             assertEquals("constructor DailyExercise() is incorrect", exercise, d.getExerciseList());
       ...
       @Test public void weeklyExercise_construct_def_02() { 
              
        WeeklyExercise d = new WeeklyExercise(exercise,pro2);
                 assertEquals("constructor WeeklyExercise() is incorrect", exercise, d.getExerciseList());
          ...
          Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
         WeeklyExercise d = new WeeklyExercise(exercise,xDuration[a],yCalorie[a],p);
             String errMsg1 = String.format("WeeklyExercise get/setProfile() incorrect");
               assertEquals(errMsg1, p, d.getProfile());
           
          }
           
          @Test public void checkWeeklyExerciseSet_GetProfile_00() { checkDailyExerciseSet_GetProfile(0); }
          @Test public void checkWeeklyExerciseSet_GetProfile_01() { checkDailyExerciseSet_GetProfile(1); }
          @Test public void checkWeeklyExerciseSet_GetProfile_02() { checkDailyExerciseSet_GetProfile(2); }
          @Test public void checkWeeklyExerciseSet_GetProfile_03() { checkDailyExerciseSet_GetProfile(3); }
          ...
          void checkWeeklyExerciseSet_GetDays(int a) {
            ...
            WeeklyExercise d = new WeeklyExercise(exercise,xDuration[a],yCalorie[a],p);
             ...
             @Test public void checkWeeklyExerciseSet_GetDays_00() { checkWeeklyExerciseSet_GetDays(0); }
             @Test public void checkWeeklyExerciseSet_GetDays_01() { checkWeeklyExerciseSet_GetDays(1); }
             @Test public void checkWeeklyExerciseSet_GetDays_02() { checkWeeklyExerciseSet_GetDays(2); }
             @Test public void checkWeeklyExerciseSet_GetDays_03() { checkWeeklyExerciseSet_GetDays(3); }
          ...
          void checkWeeklyExerciseSet_GetWeeklyCalorieTarget(int a) {
            ...
            WeeklyExercise d = new WeeklyExercise(exercise,xDuration[a],yCalorie[a],p);
             ...
             @Test public void checkWeeklyExerciseSet_GetWeeklyCalorieTarget_00() { checkWeeklyExerciseSet_GetWeeklyCalorieTarget(0); }
             @Test public void checkWeeklyExerciseSet_GetWeeklyCalorieTarget_01() { checkWeeklyExerciseSet_GetWeeklyCalorieTarget(1); }
             @Test public void checkWeeklyExerciseSet_GetWeeklyCalorieTarget_02() { checkWeeklyExerciseSet_GetWeeklyCalorieTarget(2); }
             @Test public void checkWeeklyExerciseSet_GetWeeklyCalorieTarget_03() { checkWeeklyExerciseSet_GetWeeklyCalorieTarget(3); }
         ...
         void checkWeeklyExerciseSet_GetExerciseList(int a) {
            Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
           ArrayList<Fitness> exercise2 =new ArrayList<Fitness>(Arrays.asList(fitData[a]));
         WeeklyExercise d = new WeeklyExercise(exercise2,xDuration[a],yCalorie[a],p);
            ...
            @Test public void checkWeeklyExerciseSet_GetWeeklyExerciseList_00() { checkWeeklyExerciseSet_GetExerciseList(0); }
            @Test public void checkWeeklyExerciseSet_GetWeeklyExerciseList_01() { checkWeeklyExerciseSet_GetExerciseList(1); }
            @Test public void checkWeeklyExerciseSet_GetWeeklyExerciseList_02() { checkWeeklyExerciseSet_GetExerciseList(2); }
            @Test public void checkWeeklyExerciseSet_GetWeeklyExerciseList_03() { checkWeeklyExerciseSet_GetExerciseList(3); }
             
            
          void checkWeeklyExerciseAddExercise(int a) {
             Profile p = new Profile(xPValues[a],yPValues[a],zPValues[a],gP[a]); 
                ArrayList<Fitness> exercise3 =new ArrayList<Fitness>(Arrays.asList(fit));
                WeeklyExercise d = new WeeklyExercise(exercise3,xDuration[a],yCalorie[a],p);
                d.addExercise(newFit[a]);
                String errMsg1 = String.format("WeeklyExercise AddExercise() incorrect");
                  assertEquals(errMsg1, sizeAddWeekly[a], d.getExerciseList().size());
              
             }
          
              
             @Test public void checkWeeklyExerciseAddExercise_00() { checkWeeklyExerciseAddExercise(0); }
             @Test public void checkWeeklyExerciseAddExercise_01() { checkWeeklyExerciseAddExercise(1); }
             @Test public void checkWeeklyExerciseAddExercise_02() { checkWeeklyExerciseAddExercise(2); }
             @Test public void checkWeeklyExerciseAddExercise_03() { checkWeeklyExerciseAddExercise(3); }
          ...
          void checkWeeklyExerciseRemoveExercise(int a) {
             ...
             @Test public void checkWeeklyExerciseRemoveExercise_00() { checkWeeklyExerciseRemoveExercise(0); }
             @Test public void checkWeeklyExerciseRemoveExercise_01() { checkWeeklyExerciseRemoveExercise(1); }
             @Test public void checkWeeklyExerciseRemoveExercise_02() { checkWeeklyExerciseRemoveExercise(2); }
             @Test public void checkWeeklyExerciseRemoveExercise_03() { checkWeeklyExerciseRemoveExercise(3); }
         ...
         ArrayList<Fitness> exercise =new ArrayList<Fitness>(Arrays.asList(fitDataWeekly[a]));//new ArrayList<Fitness>();
      WeeklyExercise ex = new WeeklyExercise(exercise, dayWeekly[a],calWeekly[a],pWeekly);
      ArrayList<DailyExercise> ls = ex.getWeeklyExercises();
       int j= 0;
      ...
      String errMsg1 = String.format("WeeklyExercise getWeeklyExercises() incorrect");
         ...
         @Test public void checkWeeklyExerciseGetExercises_00() { checkWeeklyExerciseGetExercises(0); }
             @Test public void checkWeeklyExerciseGetExercises_01() { checkWeeklyExerciseGetExercises(1); }
             @Test public void checkWeeklyExerciseGetExercises_02() { checkWeeklyExerciseGetExercises(2); }
             @Test public void checkWeeklyExerciseGetExercises_03() { checkWeeklyExerciseGetExercises(3); }
           
             
             void checkWeeklyExerciseGetExercises_WithIntensity(int a) {
              ArrayList<Fitness> exercise =new ArrayList<Fitness>(Arrays.asList(fitDataWeekly[a]));//new ArrayList<Fitness>();
              WeeklyExercise ex = new WeeklyExercise(exercise, dayWeekly[a],calWeekly[a],pWeekly);
              ArrayList<DailyExercise> ls = ex.getWeeklyExercises(in[a]);
               int j= 0;
              ...
              String errMsg1 = String.format("WeeklyExercise getWeeklyExercises_WithIntensity() incorrect");
                 ...
                 @Test public void checkWeeklyExerciseGetExercises_WithIntensity_00() { checkWeeklyExerciseGetExercises_WithIntensity(0); }
                     @Test public void checkWeeklyExerciseGetExercises_WithIntensity_01() { checkWeeklyExerciseGetExercises_WithIntensity(1); }
                     @Test public void checkWeeklyExerciseGetExercises_WithIntensity_02() { checkWeeklyExerciseGetExercises_WithIntensity(2); }
                     @Test public void checkWeeklyExerciseGetExercises_WithIntensity_03() { checkWeeklyExerciseGetExercises_WithIntensity(3); }
                  ...
                  double calorie[] = {5000,1500,4897,2450};
                     ...
                     double[] resultTarget4={7,3,45.5,3}; 
                        ...
                        void checkWeeklyExercise_targetedCalorieLoss(int a) throws TargetWeightException{
                        Profile p = new Profile(pAge[a],pHeight[a],pWeight[a],pGender[a]); 
               ArrayList<Fitness> exercise =new ArrayList<Fitness>(Arrays.asList(fitData[a]));//new ArrayList<Fitness>();
                  WeeklyExercise ex = new WeeklyExercise(exercise, day[a],calorie[a],p);
                  ...
                  String resultString = String.format("You need to lose %.02f calories per day or decrease your intake from %.02f to %.02f in order to lose %.2f kg of weight",resultTarget1[a],resultTarget2[a],resultTarget3[a], resultTarget4[a]);
                   assertEquals(errMsg1, resultString, ex.targetedCalorieLoss(targeted[a], withInDays[a]));
                     ...
                     @Test public void checkWeeklyExercise_targetedCalorieLoss_00() throws Exception {
                       checkWeeklyExercise_targetedCalorieLoss(0) ;
                     }
                         
                     @Test public void checkWeeklyExercise_targetedCalorieLoss_01() throws Exception {
                       checkWeeklyExercise_targetedCalorieLoss(1) ;
                     }
                         
                     @Test public void checkWeeklyExercise_targetedCalorieLoss_02() throws Exception { 
                       checkWeeklyExercise_targetedCalorieLoss(2) ;
                      }
                         
                     @Test public void checkWeeklyExercise_targetedCalorieLoss_03() throws Exception { 
                       checkWeeklyExercise_targetedCalorieLoss(3) ;
                     }
                      
                         
                        
                         @Test(expected = TargetWeightException.class) 
                         public void checkWeeklyExercise_targetedCalorieLoss_Exception() 
                         {
                          Profile p = new Profile(20,1.7,65,Gender.MALE); 
                          ArrayList<Fitness> exercise =new ArrayList<Fitness>(Arrays.asList(fitData[0]));//new ArrayList<Fitness>();
                          WeeklyExercise ex = new WeeklyExercise(exercise, day[0],calorie[0],p);
                          ex.targetedCalorieLoss(150, withInDays[0]);
//                          String errMsg1 = String.format("WeeklyExercise targetedCalorieLoss incorrect");
//                          String resultString = String.format("You need to lose %.02f calories per day or decrease your intake from %.02f to %.02f in order to lose %.2f kg of weight",resultTarget1[0],resultTarget2[0],resultTarget3[0], resultTarget4[0]);
//                           assertEquals(errMsg1, resultString, xx);
                          
                         }
                         
                    
                         
                         /* this is a tester of the question for Honors section 
                          *     students
                          * 
                          * 
                          */
                         Muscle[] []targetMuscle = {{Muscle.Biceps,Muscle.Arms},{Muscle.Glutes,Muscle.Legs,Muscle.Cardio},{Muscle.Glutes,Muscle.Legs,Muscle.Abs},{Muscle.Legs},{Muscle.Glutes,Muscle.Legs,Muscle.Abs,Muscle.Triceps,Muscle.Biceps}};
                         Fitness [][] fitResult = {{new WeightLifting(), new TaiChi(),new Yoga(),new PullUp()},{new Cycling(),new WeightLifting(), new TaiChi()},{new Cycling(),new WeightLifting(), new TaiChi()},{new Cycling(),new WeightLifting(), new TaiChi()},{new Cycling(),new WeightLifting(), new TaiChi(), new Yoga(), new PullUp()}};              
...
//                                  assertTrue(errMsg1, equalFit(fitResult[a], f));
//                              
//                             }
                          
                               
//                             @Test public void checkDailyExerciseGetAllExercises_00() { checkDailyExerciseGetAllExercises(0); }
//                             @Test public void checkDailyExerciseGetAllExercises_01() { checkDailyExerciseGetAllExercises(1); }
//                             @Test public void checkDailyExerciseGetAllExercises_02() { checkDailyExerciseGetAllExercises(2); }
//                             @Test public void checkDailyExerciseGetAllExercises_03() { checkDailyExerciseGetAllExercises(3); }
